...
const CartIconComponent = ({ onClick }) => {
    ...
    return (
        <div className='relative'>
            {
                products.length > 0 &&
                <div className='absolute -right-3 -top-2 rounded-full size-[3.5ex] pt-[2px] bg-primary text-[1.1ex] font-semibold text-white flex items-center justify-center' >
                    <div className='m-auto'>{products.length}</div>
                </div>
            }
